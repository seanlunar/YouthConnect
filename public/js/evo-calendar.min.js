...
!(function (e) {
    ...
    (i = 0),
                ...
                (a.initials = {
                    ...
                    dates: {
                        ...
                        de: {
                            ...
                            closeEventListText:
                                "Schließen Sie die Ereignisliste",
                        },
                        pt: {
                            days: [
                                "Domingo",
                        ...
                        fr: {
                            ...
                            closeEventListText:
                                "Fermer la liste des événements",
                        },
                        nl: {
                            days: [
                                "Zondag",
        ...
        (r.prototype.limitTitle = function (e, t) {
            var a = [];
            if (
                ((t = void 0 === t ? 18 : t), e.split(" ").join("").length > t)
            ) {
        ...
        (r.prototype.hasSameDayEventType = function (e, t) {
            for (
                var a = this, n = 0, i = 0;
                i < a.options.calendarEvents.length;
                i++
            )
                if (a.options.calendarEvents[i].date instanceof Array)
                    for (
                        var o = a.getBetweenDates(
                                a.options.calendarEvents[i].date
                            ),
                            r = 0;
                        r < o.length;
                        r++
        ...
        (r.prototype.initEventListener = function () {
            ...
            d(window)
                ...
                .on(
                    "resize.evocalendar.evo-" + e.instanceUid,
                    d.proxy(e.resize, e)
                ),
            ...
            if ((e.calculateDays(), !e.$elements.calendarEl.html())) {
                for (
                    var t =
                            ...
                            e.initials.dates[e.options.language]
                                .previousYearText +
                ...
                (t += "</tr></table></div>"),
                    ...
                    e.options.sidebarToggler &&
                        ...
                        e.$elements.sidebarToggler ||
                            (e.$elements.sidebarToggler = d(
                                e.$elements.sidebarEl
                            ).find("span#sidebarToggler"))),
                    e.options.eventListToggler &&
        ...
        (r.prototype.buildEventList = function () {
            ...
            if (
                (0 < n.children().length && n.empty(), t.options.calendarEvents)
            )
                for (var i = 0; i < t.options.calendarEvents.length; i++) {
                    (t.isBetweenDates(
                        t.$active.date,
                        t.options.calendarEvents[i].date
                    ) ||
            ...
            a ||
                ...
                t.$active.date === t.$current.date
                    ...
                    : (e +=
                          "<p>" +
                          t.initials.dates[t.options.language]
                              .noEventForThisDay +
                          "</p>"),
                (e += "</div>")),
                n.append(e);
            ...
            0 !== n.find('[data-event-index="' + e + '"]').length &&
                ...
                0 === n.find("[data-event-index]").length &&
                    ...
                    a.$active.date === a.$current.date
                        ? (t +=
                              "<p>" +
                              a.initials.dates[a.options.language]
                                  .noEventForToday +
                              "</p>")
                        : (t +=
                              "<p>" +
        ...
        (r.prototype.buildSidebarMonths = function () {
            this.$elements.sidebarEl
                ...
                this.$elements.sidebarEl
                    .find(
                        '.calendar-months > [data-month-val="' +
                            this.$active.month +
                            '"]'
                    )
        ...
        (r.prototype.addEventIndicator = function (t) {
            ...
            if (e instanceof Array) {
                ...
                for (var s = i.getBetweenDates(e), l = 0; l < s.length; l++)
                    d(s[l]);
            } else
                t.everyYear &&
                    (e = i.formatDate(
            ...
            function d(e) {
                0 ===
                    (n = i.$elements.innerEl.find(
                        '[data-date-val="' + e + '"]'
                    )).find("span.event-indicator").length &&
                    n.append('<span class="event-indicator"></span>'),
                    0 ===
                        n.find(
                            "span.event-indicator > .type-bullet > .type-" + o
                        ).length &&
                        ((a = '<div class="type-bullet"><div '),
                        (a += 'class="type-' + t.type + '"'),
                        t.color &&
                            (a += 'style="background-color:' + t.color + '"'),
                        (a += "></div></div>"),
        ...
        (r.prototype.selectEvent = function (e) {
            ...
            e.date instanceof Array &&
                (e.dates_range = t.getBetweenDates(e.date)),
        ...
        (r.prototype.selectYear = function (e) {
            ...
            "string" == typeof e || "number" == typeof e
                ...
                a.windowW <= a.$breakpoints.mobile &&
                    a.$UI.hasSidebar &&
                    a.toggleSidebar(!1),
                d(a.$elements.calendarEl).trigger("selectYear", [
                    a.$active.year,
                ]),
                a.buildSidebarYear(),
                a.buildCalendar();
        ...
        (r.prototype.selectMonth = function (e) {
            ...
            "string" == typeof e || "number" == typeof e
                ...
                d(t.$elements.calendarEl).trigger("selectMonth", [
                    t.initials.dates[t.options.language].months[
                        t.$active.month
                    ],
                    t.$active.month,
                ]);
        ...
        (r.prototype.selectDate = function (e) {
            ...
            "string" == typeof e || "number" == typeof e || e instanceof Date
                ...
                e || i.buildEventList(),
                d(i.$elements.calendarEl).trigger("selectDate", [
                    i.$active.date,
                    o,
                ]);
        }),
